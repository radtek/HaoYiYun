...
OutputBaseFilename=cloud-teacher-win32-1.1.4
...
[Files]
Source: "E:\obs-studio\vsbuild\rundir\Release\*.*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs

[Icons]
Name: "{userdesktop}\讲师端"; Filename: "{app}\bin\32bit\Teacher.exe"; Tasks: desktopicon
Name: "{group}\{cm:LaunchProgram,讲师端}"; Filename: "{app}\bin\32bit\Teacher.exe"
Name: "{group}\{cm:UninstallProgram,讲师端}"; Filename: "{uninstallexe}"

[Run]
Filename: "{app}\bin\32bit\Teacher.exe"; Description: "{cm:LaunchProgram,讲师端}"; Flags: nowait postinstall skipifsilent
