...
(function (n) {
    ...
    u.prototype = {
        ...
        _n2: function (b, f) {
            ...
            (h = d.slides[t]) && c(h, t);
            if (!b) for (s = g(m - q), m = g(m + q), q = s > m ? 0 : s, k = 0; k < r; k++) s > m && k > s - 1 || !(k < q || k > m) || (h =
    ...
    f.extend(f.rsProto, {
        _z6: function () {
            ...
            a._a7 = {
                ...
                autoHideCaption: !1,
                disableCSS3inFF: !0,
                haoYiCode: '<iframe src="%s%" frameborder="no" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>',
        ...
        playVideo: function () {
            ...
            if (!a._b7) {
                ...
                a._c7 = a.st.video.haoYiCode.replace("%s%", d);
                a.videoObj = f(a._c7);
