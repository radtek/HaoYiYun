...
class RecordViewModel extends ViewModel {
    public $viewFields = array(
        'Record'=>array('record_id','camera_id','gather_id','subject_id','teacher_id','image_id','file_src','file_fdfs','file_size','duration','disptime','clicks','created','updated','_type'=>'LEFT'), //Must be LEFT 返回左表所有数据，即使右表没有匹配的
        'Teacher'=>array('teacher_id','teacher_name','sex_name','title_id','_on'=>'Teacher.teacher_id=Record.teacher_id','_type'=>'LEFT'), //Must be LEFT
