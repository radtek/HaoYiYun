...
// +----------------------------------------------------------------------
// $Id: Image.class.php,v 1.2 2014/05/09 13:29:28 jackey Exp $
 ...
 * @subpackage  Util
 * @author    liu21st <liu21st@gmail.com>
 * @version   $Id: Image.class.php,v 1.2 2014/05/09 13:29:28 jackey Exp $
  +------------------------------------------------------------------------------
 */
class Image extends Think {//类定义开始
    ...
    static function buildImageVerify($length=4, $mode=1, $type='png', $width=48, $height=22, $verifyName='verify') {
		...
		setcookie($verifyName, md5($randval));
...
//        @imagestring($im, 5, 5, 3, $randval, $stringColor);
    ...
    static function showAdvVerify($type='png', $width=180, $height=40, $verifyName='verifyCode') {
		...
		setcookie($verifyName, $verifyCode);
        $im = imagecreate($width, $height);
        $r = array(225, 255, 255, 223);
        $g = array(225, 236, 237, 255);
        $b = array(225, 236, 166, 125);
