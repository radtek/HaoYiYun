...
(function($) {
    ...
    var extensionMethods = {
        ...
        float: function( settings ) {
            ...
            var options = {
                time: false,
                /* true */ // 2017.06.16 - by jackey => time format flag, default is false => second
                handle: true,
                /* false */
                pips: false,
                /* true */
                ...
                formatLabel: function(value) {
                    // 2017.06.16 - by jackey => process time format display...
                    if( this.time ) {
            ...
            slider.element
                ...
                .on( options.event + ".sliderFloat", function( e, ui ) {
                  if( $(ui.handle).length > 1 ) {
                    for(var i = 0; i < ui.handle.length; ++i) {
                      var uiValue = ( $.type( ui.values[i] ) === "array" ) ? ui.values[i] : [ ui.values[i] ];
                      var arrLabel = getPipLabels( uiValue );
                      var val = options.formatLabel( arrLabel[0] );
                      $(ui.handle[i]).find(".ui-slider-tip").html( val );
                    }
                  } else {
